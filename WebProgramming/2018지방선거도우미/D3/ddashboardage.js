...
function dashboardA(file) {
    ...
    function dataViz(incomingData) {
        ...
        function segColor(c) { return { twenty: "#fee5d9", thirty: "#fcae91", fourty: "#fb6a4a", fifty: "#de2d26", sixty: "#a50f15" }[c]; }
        ...
        incomingData.forEach(function (d) {
            ...
            sum += d.total;
            console.log(encodeURIComponent(d.candidate));
            can[i++] = d.candidate;
        });
        ...
        function legend(lD) {
            ...
            var legend = d3.select("#dashboardA").append("table").attr('class', 'legend');
