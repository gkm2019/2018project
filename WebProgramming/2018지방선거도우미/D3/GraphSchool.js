...
function dashboardS(file) {
    ...
    function S_dataViz(incomingData) {
        ...
        function segColor(c) { return { A: "#E1F5fe", B: "#b3e5fc", C: "#81d4fa", D: "#4fc3f7", E: "#29b6f6", F: "#03a9f4", G: "#039be5" }[c]; }
        ...
        function pieChart(pD) {
            ...
            var piesvg = d3.select("#dashboardS")
                .append("svg")
                .attr("width", pieDim.w)
        ...
        function legend(lD) {
            ...
            tr.append("td").text(function (d) {
                ...
                .attr("class", "S_columnText");

            // create the third column for each segment.
            tr.append("td")
                .attr("class", 'S_legendFreq')
                .text(function (d) { return d3.format(",")(d.freq); })
                .style("font-size", "15px");

            // create the fourth column for each segment.
            tr.append("td")
                .attr("class", 'S_legendPerc')
