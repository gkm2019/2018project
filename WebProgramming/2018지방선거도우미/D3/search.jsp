...
//후보지역 명, 총 후보자 수 출력
		...
		candi_name=(String)session.getAttribute("candi_name");
		System.out.println(candi_name);
		
  %>
    
<!--[if lt IE 7]>     e <html class="no-js lt-ie9 lt-ie8 lt-ie7" lang=""> <![endif]-->
     ...
     <!-- 메인로고 여기다 -->            <h1 style="font-family: 'Hanna', sans-serif; font-size:30px">제<em style="color:blue;">7 </em>회 전국동시지방선거
                                    ...
                                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                        <ul class="nav navbar-nav navbar-right">
                                            ...
                                            <li><a href="location.html">사전 투표소</a></li>
                                        </ul>    
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <a name="Trip_intro"></a>
                            <h1 style="font-family: 'Hanna', sans-serif; font-size:30px; text-align:center;">후보자 검색
                            <img src="assets/images/map_point.png" width="40" height="40"></h1>
                            <h2 style="font-family: 'Hanna', sans-serif; font-size:20px"></h2>
                        </div><!-- End of head title -->
                        <!-- 여기까지가 타이틀!!!!!!!!!!!!!!!!!!!!!!!!   안지우는게 나을듯!~필요하면 지우셔도 됩니다 -->
 <!-- ==============================================아래 수정 가능============================================================================ -->                       
                        
                        
                        
                       <form  method="post" class="register-form" action="searchAction.jsp">
							
							<div class="form-group">
								<input type="text" name="candi_name" id="candi_name" class="form-control" placeholder="후보자 이름" tabindex="20">
  ...
  if(candi_name==null){}
	  ...
	  System.out.println("검색받은 후보자 이름은?"+candi_name);
  }
 for(int i=0;i<candilist.size();i++){
	 CandidateDTO cdto = candilist.get(i);
	 String name=cdto.getCandiName();
	 
	 if(name.equals(candi_name)){
