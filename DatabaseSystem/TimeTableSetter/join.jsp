	...
	<div class="mdl-grid site-copy">
						<div class="mdl-cell mdl-cell--12-col">
							<div class="mdl-card__supporting-text">
								<p>CBNU TIMETABLE에 회원가입을 해봅시다!</p>
								<form action="Join.do"
									method="POST" class="form-contact">
									<div
										class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text" id="stdID" name="stdID" maxlength="20">
										<label class="mdl-textfield__label" for="stdID">학번</label>
									</div>
									<BR>
										<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										<input class="mdl-textfield__input" type="text" id="stdName" name=""stdName"" maxlength="20">
										<label class="mdl-textfield__label" for=""stdName"">이름</label>
									</div>	
									<div
